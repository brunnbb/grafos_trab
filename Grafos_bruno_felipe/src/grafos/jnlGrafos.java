...
public class jnlGrafos extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnBFS, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnKruskal, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                if (this.novoGrafo != null) {
                    this.novoGrafo.gravarArquivo(arqSaida);
                    this.novoGrafo = null;
                } else {
    ...
    private void btnDFSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDFSActionPerformed
        if (jList.getSelectedValue() != null && grafo != null) {
            Vertice selecionado = (Vertice) jList.getSelectedValue();
            listaRes.removeAll();
            listaRes.setListData(Algoritmos.percorreProfundidade(grafo, selecionado).toArray());
        }
    ...
    private void btnBFSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBFSActionPerformed
        if (jList.getSelectedValue() != null && grafo != null) {
            Vertice selecionado = (Vertice) jList.getSelectedValue();
            listaRes.removeAll();
            listaRes.setListData(Algoritmos.percorreLargura(grafo, selecionado).toArray());
        }
    ...
    private void btnKruskalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKruskalActionPerformed
        if (grafo != null) {
            listaRes.removeAll();
            novoGrafo = Algoritmos.calcularKruskal(grafo);

            ArrayList<String> resultados = new ArrayList<>();
            resultados.add("Lista da árvore Mínima:");
            
            for (Vertice v : novoGrafo.obterVertices()) {
                resultados.add(v.obterLinhaArquivo());
            }
            
            resultados.add("Peso total mínimo: " + novoGrafo.getPesoTotalMinimo());
            listaRes.setListData(resultados.toArray());
        }
