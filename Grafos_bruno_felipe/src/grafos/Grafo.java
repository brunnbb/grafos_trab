...
public class Grafo{
    ...
    private double pesoTotalMinimo = 0;
    
    public Grafo() {

    }
    //Criado para facilitar o display
    public double getPesoTotalMinimo() {
        return pesoTotalMinimo;
    }
    //Criado para facilitar o display
    public void setPesoTotalMinimo(double pesoTotalMinimo) {
        this.pesoTotalMinimo = pesoTotalMinimo;
    }
